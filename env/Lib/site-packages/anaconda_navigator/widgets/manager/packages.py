...
from qtpy.QtWidgets import (QApplication, QDialogButtonBox, QHBoxLayout,
...
class ComboBoxPackageFilter(ComboBoxBase):
    ...
    def __init__(self, *args, **kwargs):
        """Combobox used in CSS styling."""
        super(ComboBoxPackageFilter, self).__init__(*args, **kwargs)
...
class CondaPackagesWidget(QWidget):
    ...
    def __init__(self, parent, config=CONF):
        ...
        self.table.sig_previous_focus.connect(lambda: self.table_first_row.widget_before.setFocus())
