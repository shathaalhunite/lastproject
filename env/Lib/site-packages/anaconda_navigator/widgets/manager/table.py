...
from qtpy.QtWidgets import (QAbstractItemView, QHeaderView, QItemDelegate,
                            QMenu, QTableView)
...
class TableCondaPackages(QTableView):
    ...
    def filter_changed(self):
        ...
        if self.source_model:
            ...
            if action_count:
                ...
                selected_text = '{0} package{1} selected'.format(action_count, plural)
    ...
    def _convert_action_index_to_name(self, action_index):
