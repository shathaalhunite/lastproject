...
class LabelImageLinkVertical(QWidget):
    def __init__(self, text, url, image, width, height, margin):
        """
        ...
        """
        super(LabelImageLinkVertical, self).__init__()
        self.setFocusPolicy(Qt.StrongFocus)  # Needed on OSX
        self.setAttribute(Qt.WA_LayoutUsesWidgetRect, True)  # Needed on OSX
    ...
    def enterEvent(self, event):
        ...
        """
        super(LabelImageLinkVertical, self).enterEvent(event)
        update_pointer(Qt.PointingHandCursor)
    ...
    def leaveEvent(self, event):
        ...
        """
        super(LabelImageLinkVertical, self).leaveEvent(event)
        update_pointer()
