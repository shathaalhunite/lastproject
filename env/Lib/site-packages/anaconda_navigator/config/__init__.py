...
if LINUX:
    try:
        p = subprocess.check_call(['dpkg', '--version'], stdout=PIPE, stderr=PIPE)
        LINUX_DEB = True
    ...
    try:
        p = subprocess.check_call(['rpm', '--version'], stdout=PIPE, stderr=PIPE)
        LINUX_RPM = True
    except Exception as e:
        LINUX_RPM = False
        # print(e)
    ...
    try:
        p = subprocess.check_call(['dnf', '--version'], stdout=PIPE, stderr=PIPE)
        LINUX_DNF = True
    except Exception as e:
        LINUX_DNF = False
        # print(e)
...
ENTERPRISE_BRAND = 'Enterprise 4 Repository'
TEAM_EDITION_BRAND = 'Team Edition'
