...
class _ProjectAPIWrapper(QObject):
    ...
    def create_project(self, path, make_directory=False, name=None, icon=None, description=None):
    ...
    def upload(self, project, site=None, username=None, token=None, log_level=None):
        ...
        return self._create_worker(method, project, site=None, username=None, token=None, log_level=None)
