...
ANACONDA_TEAM_EDITION_LOGIN_LOGO = osp.join(LOGO_PATH, 'Anaconda_Logo_RGB_Team_Edition.png')
ANACONDA_ORG_EDITION_LOGIN_LOGO = osp.join(LOGO_PATH, 'Anaconda_Logo_RGB_Org.png')
ANACONDA_COMMERCIAL_EDITION_LOGIN_LOGO = osp.join(LOGO_PATH, 'Anaconda_Logo_RGB_Commercial_Edition.png')
ANACONDA_ENTERPRISE_EDITION_LOGIN_LOGO = osp.join(LOGO_PATH, 'Anaconda_Logo_RGB_Enterprise_Edition.png')
